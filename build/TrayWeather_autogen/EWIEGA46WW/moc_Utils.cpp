...
namespace {
struct qt_meta_tag_ZN19ClickableHoverLabelE_t {};
} // unnamed namespace

template <> constexpr inline auto ClickableHoverLabel::qt_create_metaobjectdata<qt_meta_tag_ZN19ClickableHoverLabelE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "ClickableHoverLabel"
    ...
    return QtMocHelpers::metaObjectData<ClickableHoverLabel, qt_meta_tag_ZN19ClickableHoverLabelE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ClickableHoverLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<ClickableLabel::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19ClickableHoverLabelE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19ClickableHoverLabelE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19ClickableHoverLabelE_t>.metaTypes,
    nullptr
} };

void ClickableHoverLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<ClickableHoverLabel *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
const QMetaObject *ClickableHoverLabel::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *ClickableHoverLabel::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19ClickableHoverLabelE_t>.strings))
        return static_cast<void*>(this);
    return ClickableLabel::qt_metacast(_clname);
}

int ClickableHoverLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
