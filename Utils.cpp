...
// Project
#include <Utils.h> // Tvůj hlavičkový soubor
#include "linux_fix.h"
...
{
  auto text = csvText;
  auto parts = text.remove('\n').split(',', Qt::KeepEmptyParts, Qt::CaseInsensitive);
...
void changeLanguage(const QString &lang)
{
  if(!s_appTranslator.isEmpty())
  {
    ...
    (void)s_appTranslator.load(QString());
  }
...
#ifdef Q_OS_WIN
    // Toto se zkompiluje POUZE na Windows, v Qt 6 je to správný způsob
