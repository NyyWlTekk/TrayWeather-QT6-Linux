...
, public Ui_WeatherDialog
{
  ...
  private:
     ...
     *
     */
    void updateAxesRanges(QChart *chart);
    ...
    QChartView            			*m_weatherChart;     /** weather forecast chart view.    */
    QChartView            			*m_pollutionChart;   /** pollution forecast chart view.  */
    QChartView            			*m_uvChart;          /** UV forecast chart view.         */    
    ...
    QWebEngineView                  *m_webpage;          /** maps webpage.                   */
