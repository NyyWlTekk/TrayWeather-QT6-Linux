...
: public QLabel
{
  ...
  public:
     ...
     *
     */
    explicit ClickableLabel(QWidget *parent=0, Qt::WindowFlags f = {})
    : QLabel(parent, f)
    {};
     ...
     *
     */
    explicit ClickableLabel(const QString &text, QWidget *parent=0, Qt::WindowFlags f = {})
...
: public ClickableLabel
{
  ...
  public:
     ...
     *
     */
    explicit ClickableHoverLabel(QWidget *parent=0, Qt::WindowFlags f = {})
     ...
     *
     */
    explicit ClickableHoverLabel(const QString &text, QWidget *parent=0, Qt::WindowFlags f = {})
